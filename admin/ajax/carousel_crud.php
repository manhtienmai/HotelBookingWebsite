<?php
    ...
    if(isset($_POST['add_image'])) {
        $img_r = uploadImage($_FILES['picture'], CAROUSEL_FOLDER );// hamf nay và định nghĩa ben essentials
                ...
                <div class="col-md-4 mb-3">
                    <div class="card bg-dark text-white">
                        ...
                        <div class="card-img-overlay text-end">
                            <button type="button" onclick="rem_image($row[sr_no])" class="btn btn-danger btn-sm shadow_none">
