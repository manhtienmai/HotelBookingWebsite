<?php
    ...
    if(isset($_POST['add_member'])) {
        $frm_data = filteration($_POST);
        $img_r = uploadImage($_FILES['picture'], ABOUT_FOLDER );// hamf nay và định nghĩa ben essentials
                ...
                <div class="col-md-2 mb-3">
                    <div class="card bg-dark text-white">
                        ...
                        <div class="card-img-overlay text-end">
                            <button type="button" onclick="rem_member($row[sr_no])" class="btn btn-danger btn-sm shadow_none">
