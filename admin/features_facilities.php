            ...
            <form id="facility_s_form">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-blod">Icon</label>
        ...
        function add_feature() {
            ...
            xhr.onload = function() {
                ...
                if (this.responseText == 1) {
                    ...
                    get_features(); // show ra tất cả db có   
                } else {
        ...
        function add_facility() {
            ...
            xhr.onload = function() {
                ...
                if (this.responseText == 'inv_img') {
                    alert('error', 'Only SVG images are allowed!'); // hàm bên essentials
                    ...
                    get_facilities(); // show ra tất cả db có
                }
            }
            xhr.send(data);
        }
