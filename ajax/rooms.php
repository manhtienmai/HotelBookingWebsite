<?php
    ...
    if(isset($_GET['fetch_rooms'])) {
        ...
        //checkin and checkout filter valid
        ...
        //count number and output variable to store room cards
        $count_room = 0;
        $output = "";
        ...
        while ($room_data = mysqli_fetch_assoc($room_res)) {
          ...
          if ($chk_avail['checkin'] != '' && $chk_avail['checkout'] !='') {
            ...
            $value = ['booked',$room_data['id'],$chk_avail['checkin'],$chk_avail['checkout']];
          ...
          //get features of room with filter
