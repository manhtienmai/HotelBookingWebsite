...
<body class="bg-light">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <?php 
                  ...
                  while($row = mysqli_fetch_assoc($facilities_q)) {
                    echo<<< facilities
                      <div class="mb-2">
                        <input type="checkbox" onclick="fetch_rooms()" name="facilities" value="$row[id]" class="form-check-input shadow-none mb-1" id="$row[id]">
  ...
  <script>
    ...
    function guests_filter() {
      if(adults.value > 0 || checkin.value >0) {
        fetch_rooms();
